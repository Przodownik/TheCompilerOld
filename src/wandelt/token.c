...
{
	static_assert(TOKEN_TYPE_COUNT == 49, "Update token_type_to_cstr when adding new token types");
...
{
	static_assert(TOKEN_TYPE_COUNT == 49, "Update token_type_to_lexeme_cstr when adding new token types");
